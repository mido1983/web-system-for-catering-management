...
<form method="get" class="bg-white p-4 rounded shadow mb-4 grid grid-cols-1 md:grid-cols-4 gap-2">
    ...
    <a class="bg-slate-700 text-white rounded text-center py-2" href="/admin/planner?date_from=<?php echo e($date_from); ?>&date_to=<?php echo e($date_to); ?>&export=csv">ייצוא CSV</a>
</form>
